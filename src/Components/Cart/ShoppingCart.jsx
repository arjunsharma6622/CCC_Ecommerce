...
const ShoppingCart = () => {
  ...
  return (
    <div className="shopping-cart">
      {!orderPlaced && <h2>Your Shopping Cart</h2>}
      ...
      : (
          cart.length === 0 ? (
            <div className="empty-cart">
              ...
              <img src="./empty-cart.png" alt="" width={'50%'} />
            ...
            <div className='cart-items-wrapper'>
              ...
              <div className="cart-total">
                ...
                <div className="summary-item">
                  <p>Discount on MRP </p>
                  <span style={{ color: '#4BB59A' }}>-₹ {calculateTotalMRP() - calculateTotalPrice()}</span>
                </div>
                <div className="summary-item">
                  <p>Coupon Discount</p>
                ...
                <div className="summary-item final-price">
                  <p>Total Amount</p>
                  <span> ₹ {calculateTotalPrice() + 55}</span>
                </div>
